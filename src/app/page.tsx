  ...
  return (
    <main>
      <div className="grid min-h-screen place-items-center">
        <div className="w-full max-w-screen-lg grid">
          <div className="mb-24 max-w-3xl">
            ...
            <p className="max-w-lg text-lg lg:text-xl">
              We development of smart digital solutions for businesses looking
          ...
          <div className="grid gap-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div className="rounded-lg border bg-zinc-100 p-4 shadow-md">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit}>
                <Input
                  value={input}
                  className="w-full text-lg py-6 px-5"
